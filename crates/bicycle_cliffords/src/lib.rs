...
pub use draft_single_shot::{
    ...
    SingleShotSourceWitness, SingleShotBuildProfile, SingleShotExactTableReport,
    SingleShotTailProvenanceRecord, SingleShotWeightedAuditReport,
    WeightedAuditConditionalHistogramReport, WeightedAuditCostAlphabetReport,
    WeightedAuditModelCompareReport, WeightedAuditSamplePath, WeightedAuditSourceKind,
    ...
    compute_ours_single_shot_exact_table_from_native_rows,
    compute_ours_single_shot_weighted_audit_from_native_rows,
    compute_ours_single_shot_tail_costs_from_native_rows,
